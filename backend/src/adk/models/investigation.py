...
class AgentMessage(BaseModel):
    ...
    ui_summary: Optional[List[Dict[str, Any]]] = Field(
        None, description="List of UI summaries with timestamps for display"
    )
...
class Investigation(BaseModel):
    ...
    ui_summary: Optional[List[Dict[str, Any]]] = Field(
        None, description="List of UI summaries with timestamps generated by after_agent_callback"
    )

    final_comprehensive_report: Optional[Dict[str, Any]] = Field(
        None, description="Final comprehensive report generated by the investigation"
    )
